...
class Article
{
    ...
    #[Assert\NotBlank('message="titre doit pas etre null"')]
    #[Assert\Type('message="titre doit pas etre null"')]
    private ?string $titre = null;

    #[ORM\Column(length: 255, nullable: true)]
    
    #[Assert\NotBank('message="prix doit pas etre null"')]
    #[Assert\Type(' type = "integer" , message="le type doit pas etre entier"')]
    private ?string $prix = null;

    #[ORM\Column(length: 255, nullable: true)]
    #[Assert\NotBank('message="contenu doit pas etre null"')]
    private ?string $contenu = null;

    
    #[ORM\Column(length: 255, nullable: true)]
    #[Assert\NotBank('message="image doit pas etre null"')]
    private ?string $image = null;

    #[ORM\Column(length: 255, nullable: true)]
    #[Assert\NotBank('message="titre doit pas etre null"')]
